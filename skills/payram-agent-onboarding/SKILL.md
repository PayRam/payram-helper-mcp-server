...
| Skill | Purpose |
|-------|---------|
| [`payram-setup`](https://github.com/PayRam/payram-helper-mcp-server/tree/main/skills/payram-setup) | Standard deployment with web dashboard |
| [`payram-payment-integration`](https://github.com/PayRam/payram-helper-mcp-server/tree/main/skills/payram-payment-integration) | Integrate payments into applications |
| [`payram-webhook-integration`](https://github.com/PayRam/payram-helper-mcp-server/tree/main/skills/payram-webhook-integration) | Handle payment event callbacks |
| [`payram-checkout-integration`](https://github.com/PayRam/payram-helper-mcp-server/tree/main/skills/payram-checkout-integration) | Checkout flow implementation |
