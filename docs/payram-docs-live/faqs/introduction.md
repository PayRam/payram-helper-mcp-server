For the complete documentation index, see [llms.txt](https://docs.payram.com/llms.txt). This page is also available as [Markdown](https://docs.payram.com/faqs/introduction.md).
...
![](https://docs.payram.com/~gitbook/image?url=https%3A%2F%2Fcontent.gitbook.com%2Fcontent%2Fwm1DIvbGMREWT1TdLPtz%2Fblobs%2FrTmG3iv3XTJY2VJU7lnR%2Fpayram-faqs.png&width=768&dpr=3&quality=100&sign=aa61e727&sv=2)

-   [What is PayRam?](/faqs/introduction#what-is-payram)
    
-   [How do I get started, and how fast can I go live?](/faqs/introduction#how-do-i-get-started-and-how-fast-can-i-go-live)
    
-   [What are the minimum server requirements to run PayRam?](/faqs/introduction#what-are-the-minimum-server-requirements-to-run-payram)
    
-   [Which cryptocurrencies and blockchains does PayRam support?](/faqs/introduction#which-cryptocurrencies-and-blockchains-does-payram-support)
    
-   [Does PayRam handle fiat currencies (USD, EUR, etc.)?](/faqs/introduction#does-payram-handle-fiat-currencies-usd-eur-etc)
    
-   [What fees does PayRam charge?](/faqs/introduction#what-fees-does-payram-charge)
    
-   [Are there any transaction limits?](/faqs/introduction#are-there-any-transaction-limits)
    
-   [How do I integrate PayRam with my platform?](/faqs/introduction#how-do-i-integrate-payram-with-my-platform)
    
-   [Is there a sandbox or test mode?](/faqs/introduction#is-there-a-sandbox-or-test-mode)
    
-   [How secure is PayRam?](/faqs/introduction#how-secure-is-payram)
    
-   [Does PayRam require KYC/AML?](/faqs/introduction#does-payram-require-kyc-aml)
    
-   [How are refunds and chargebacks handled?](/faqs/introduction#how-are-refunds-and-chargebacks-handled)
    
-   [What happens if a customer underpays or overpays?](/faqs/introduction#what-happens-if-a-customer-underpays-or-overpays)
    
-   [Can I set up recurring subscriptions or billing?](/faqs/introduction#can-i-set-up-recurring-subscriptions-or-billing)
    
-   [Which industries benefit most from PayRam?](/faqs/introduction#which-industries-benefit-most-from-payram)
    
-   [How do I migrate from testnet to mainnet?](/faqs/introduction#how-do-i-migrate-from-testnet-to-mainnet)
    
-   [What support options are available?](/faqs/introduction#what-support-options-are-available)
...
[PreviousOperator Mode](/features/operator-mode)[NextGeneral FAQ's](/faqs/general-faqs)
