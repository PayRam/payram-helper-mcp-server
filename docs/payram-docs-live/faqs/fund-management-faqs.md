For the complete documentation index, see [llms.txt](https://docs.payram.com/llms.txt). This page is also available as [Markdown](https://docs.payram.com/faqs/fund-management-faqs.md).
...
-   [What is Smart Consolidation (Fund Sweep)?](/faqs/fund-management-faqs#what-is-smart-consolidation-fund-sweep)
    
-   [What is a Gas Station in PayRam?](/faqs/fund-management-faqs#what-is-smart-consolidation-fund-sweep)
...
#### What is a Gas Station in PayRam?[](#what-is-a-gas-station-in-payram)
...
[PreviousGeneral FAQ's](/faqs/general-faqs)[NextReferral FAQ's](/faqs/referral-faqs)
